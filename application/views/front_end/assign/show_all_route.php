<?php 
  ...
  $jquery_jvectormap_css=$this->config->item('jquery_jvectormap_css');
  $jquery_jvectormap_js=$this->config->item('jquery_jvectormap_js');
  $routemap_js=$this->config->item('routemap_js');
...
<script type="text/javascript">
   var markers =<?php echo $all_route; ?>;
        ...
        for (i = 0; i < markers.length; i++)
         {
            var data = markers[i];
             ...
             var image = {
          url: '<?=base_url()."images/flag_icons/"?>'+data.marker_img,      
