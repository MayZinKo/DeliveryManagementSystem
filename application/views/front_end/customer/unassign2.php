...
<div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    ...
                    <table id="" class="display">
                      ...
                      <tbody>
                      <?php $i=1; ?>
                      <?php  foreach ($start_unassign as $val): ?>
                        <?php //var_dump($val) ?>
                        <tr>
                          <td><?=$i?></td>
                          <td><?=$val['name']?></td>
                          ...
                          <td><?=$val['township']?></td>
                          <td><?=$val['timestamp']?></td>
                         <?php $toAssignController=$assign_controller."/unassign/".$val['customer_id'];?>
                          <td><a href="<?=base_url($toAssignController)?>">Assign?  <i class="glyphicon glyphicon-map-marker"></i> </a></td>
                          <td>
  ...
  <div class="modal fade" id="myModal<?=$val['customer_id']?>" role="dialog">
   ...
   <div class="row">
            <!-- left column -->
    <input type="text" name="view_status" value="unassign" hidden="trued"> 
     ...
     <!-- Modal -->
                  ...
                  <div class="tab-pane" id="tab_2">
                     ...
                     <table id="" class="display">
                      ...
                      <tbody>
                      <?php $i=1; ?>
                      <?php  foreach ($end_unassign as $val): ?>
                        <?php //var_dump($val) ?>
                        <tr>
                          <td><?=$i?></td>
                          <td><?=$val['name']?></td>
